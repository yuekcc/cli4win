...
| agent       | 一个简单的 coding agent，依赖 xh，支持多轮对话，支持函数调用。**不再演进** 后续版本见 [mini-pi](https://github.com/yuekcc/mini-pi) |

## 编译

需要 [c3c 0.7.11](https://github.com/c3lang/c3c)，和 Bash。Bash 通过[git for windows](https://gitforwindows.org/)安装。
